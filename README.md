...
- [AtAt](https://atatapp.com) - Native macOS app that drives your local Codex CLI from any text field via `@@`. Attaches screens, clipboard history, or Finder files, inserts answers in place, and hands off complex tasks to your interactive terminal.
