...
- [review-pro](https://github.com/tufantunc/review-pro) by [Tufan Tunç](https://github.com/tufantunc) - Tiered code review in three stages: triage classifies the diff and selects which of twelve specialist reviewers to dispatch, those reviewers run in parallel, and synthesis dedups their findings into one verdict. Sixteen stack packs add language-specific signals. Installs into Codex with skills to ~/.agents/skills/ and agents auto-transformed to TOML.
...
- [Agent Island](https://github.com/tristan666666/agent-island) - Free, MIT-licensed native companion for Codex, Claude Code, Gemini, Grok and Cursor: local working/stalled/your-turn state, your-turn alerts, and provider usage with on-device cost estimates. macOS and Windows, no account, no telemetry.
