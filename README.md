...
- [OrcaPromptVault](https://github.com/Continuum-AI-Corp/OrcaPromptVault) by [Continuum AI](https://github.com/Continuum-AI-Corp) - Codex CLI's own system prompts and tool schemas, recorded off the wire and dated: `gpt-5.6-luna` 20,815 characters / 3 tools, `gpt-5.6-sol` 23,354 / 9, plus `gpt-6-astra`. Each file carries the command that reproduces it, so you can check what your Codex version actually sends before writing an AGENTS.md against it.
