...
- [Tree Ring Memory](https://github.com/TerminallyLazy/Tree-Ring-Memory) - Local-first Rust memory lifecycle layer for Codex, Claude Code, OpenCode, and other agent workflows, with SQLite/FTS recall, audit, forgetting, consolidation, and project bridge guidance.
