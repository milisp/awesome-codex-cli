...
- [Mimir](https://github.com/erayendes/mimir) - macOS menu bar app showing real-time usage quotas and reset countdowns for Claude Code, Codex, and Antigravity, with no backend.
