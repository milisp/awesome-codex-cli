...
- [tmux-codex-auto-continue](https://github.com/yeahdongcn/tmux-codex-auto-continue) - Fail-closed tmux watcher that resumes interrupted Codex CLI turns and selected retry/wait states with real Enter submission.
